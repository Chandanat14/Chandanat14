...
class_dirs = ["Bacterial Blight", "Downy Mildew", "Dead Heart", "Healthy"]
...
def preprocess_to_hsv(image):
    ...
    # Optionally, you could apply masking or thresholding to focus on certain HSV ranges
    # For example, you can set specific ranges for detecting diseased areas:
    lower_bound = np.array([25, 40, 40])   # Adjust these values based on the image characteristics
...
# Save the model
cnn_model.save("rice_leaf_disease_classifier_hsv.h5")
